...
def clean_up(combined_record_group: list):
    ...
    for combined_record in combined_record_group:
        combined_list = list(combined_record)
        combined_list.remove(combined_record[1])
        combined_string += str(tuple(combined_list)) + "\n"
